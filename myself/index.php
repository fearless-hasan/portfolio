 ...
 */
    ...
    if(isset($_POST['admin_login'])){
        $message = Controller::adminLoginCheck($_POST);
    }
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 m-auto">
                                    <button type="submit" class="btn btn-outline-primary btn-block" name="admin_login">Sign in</button>
                                </div>
                            </div>

                            <div class="form-group">
                                <h3 class="text-center btn-danger"><?=$message; ?></h3>
                            </div>
                        </form>
                    </div>
                </div>
